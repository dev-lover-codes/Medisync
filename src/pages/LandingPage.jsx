        ...
        <nav className="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-extrabold tracking-tight text-purple-700 dark:text-purple-300 font-headline">MediSync</span>
            </div>
              ...
              <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-primary to-[#8e7494] p-10 rounded-xl shadow-xl flex flex-col justify-between text-white overflow-hidden relative group">
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/20 backdrop-blur-md rounded-xl p-4 border border-white/10">
                    ...
                    <p className="italic text-sm">"Hello, I'm your MediSync assistant. How are you feeling today?"</p>
                  </div>
                </div>
        ...
        <section id="mobile" className="px-6 py-24 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 order-1 lg:order-2 space-y-8">
              ...
              <p className="text-lg text-on-surface-variant">Manage vitals, chat with AI, and view your 3D digital twin—all from the MediSync mobile application. Synchronized with your clinic in real-time.</p>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                {
                  text: "Managing my family's health used to be a nightmare. MediSync centralizes everything beautifully. The 3D charts are actually helpful!",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-4 gap-12 pb-16 border-b border-outline-variant/20">
            <div className="col-span-1 space-y-6">
              <span className="text-3xl font-extrabold tracking-tight text-purple-700 font-headline">MediSync</span>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-on-surface-variant">
                <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">mail</span> support@MediSync.com</li>
          ...
          <div className="flex justify-between items-center pt-8 text-xs text-outline font-semibold tracking-wider uppercase">
            <p>© 2026 MediSync Healthcare Systems. All Rights Reserved.</p>
