      ...
      <div className="w-full lg:w-3/5 flex justify-center items-center p-8 sm:p-12 md:p-20 bg-surface">
        <div className="w-full max-w-lg space-y-10">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-primary/20 text-on-surface py-4 rounded-full font-headline font-bold text-lg shadow-md hover:bg-surface-container-low transition-all active:scale-[0.98] disabled:opacity-70 group"
          >
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            <span className="text-sm font-medium text-on-surface-variant">or use email</span>
            <div className="h-[1px] flex-1 bg-outline-variant/50"></div>
          </div>
