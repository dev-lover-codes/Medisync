...
Reference full template: `/home/user/Medisync/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Medisync/.gemini/get-shit-done/templates/state.md`.
