...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Medisync/.gemini
                  → checks /home/user/Medisync/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Medisync/.gemini/get-shit-done
                  → writes to /home/user/Medisync/.gemini/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/user/Medisync/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/user/Medisync/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/user/Medisync/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
