...
<reference>
@/home/user/Medisync/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Medisync/.gemini/get-shit-done/references/user-profiling.md` to load:
