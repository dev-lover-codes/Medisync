...
- **Global scope**: `/home/user/Medisync/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/user/Medisync/.gemini/notes/`)
...
2. Glob `/home/user/Medisync/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/user/Medisync/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/user/Medisync/.gemini/notes/` — works in any directory
